...
//formulario con estado por cada input
    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="radio" id="svelte" name="sabor" value="svelte" onChange={(e)=>setSabor(e.target.value)} defaultChecked/>
                <label htmlFor="svelte">Svelte</label>
                <input type="radio" id="vanilla" name="sabor" value="vanilla" onChange={(e)=>setSabor(e.target.value)}/>
                <label htmlFor="vanilla">Vanila JS</label>
...
//formulario solo con un estado para todo el formulario
export default function Formularios(){
    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmit}>
                <label htmlFor="nombre">Nombre:</label>
                {/* input controlado mediante el estado */}
                <input 
                type="text" 
                id="nombre" 
                name="nombre" 
                ...
                <p>Elige tu sabor JS favorito:</p>
                <input type="radio" id="svelte" name="sabor" value="svelte" onChange={handleChange} defaultChecked/>
                <label htmlFor="svelte">Svelte</label>
